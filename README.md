...
- También puedes añadir `/tree/nombre_de_la_rama` a la URL del repositorio para ir directamente a la rama que quieras.
...
1. Asegúrate de tener instalado:
   ...
   - [Python 3.12](https://www.python.org/downloads/) (o versión 3.10+ compatible)  
   - [Node.js LTS (20+)](https://nodejs.org/) y `npm`  
   - Opcional: [Azure CLI](https://learn.microsoft.com/cli/azure/install-azure-cli) para los pasos de despliegue en Azure.
